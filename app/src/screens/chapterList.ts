...
// reader means scrolling all the way down again to find your place.
// Rotating the list so the last-read chapter is item 0 fixes that with no
// SDK support needed - it's simply the first thing you see.
